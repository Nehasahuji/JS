...
function checkWinner(dolphinAverageScore,koalasAverageScore){

    if(dolphinAverageScore>2*koalasAverageScore){
        console.log(`Dolphins win (${dolphinAverageScore} vs. ${koalasAverageScore} )`);
    }
    else if(koalasAverageScore>2*dolphinAverageScore){
        console.log(`Koalas win (${koalasAverageScore} vs. ${dolphinAverageScore}  )`);
    }else{
